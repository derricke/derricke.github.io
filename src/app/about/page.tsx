            ...
            <div className="lg:col-span-8">
              ...
              <div className="prose prose-zinc dark:prose-invert max-w-none space-y-6 text-zinc-600 dark:text-zinc-400">
                <p className="text-lg leading-relaxed">
                  With over two decades of experience in the technology sector, I have cultivated a deep expertise in transforming complex business requirements into robust, highly scalable digital platforms. My career has been heavily anchored in the fast-paced world of e-commerce, where I specialize in architecting expansive digital ecosystems and driving technical strategy from the ground up. My background includes directing technical strategy for a $30M+ ARR Health & Wellness brand and stewarding a portfolio of $10M+ ARR storefronts in Beauty & Skincare, demonstrating my ability to scale operations across diverse categories and market segments. Whether leading high-complexity platform migrations across enterprise systems or establishing unified coding standards for global teams, my focus remains steadfast on delivering solutions that directly support long-term revenue growth and operational excellence. I have managed major migrations and built custom solutions across platforms like Shopify, Magento, and Salesforce Commerce.
                </p>
                <p className="text-lg leading-relaxed">
                ...
                <p className="text-lg leading-relaxed">
                  I drive measurable business impact by optimizing PDP performance and site speed to improve CVR and CRO, scaling subscription systems through complex recurring billing integrations, and improving customer lifecycle operations with automated ERP and 3PL fulfillment workflows. I also bring deep experience in regulated DTC categories, including supplement and skincare, where I maintain PCI compliance, support FDA-required disclosures, and secure sensitive data during high-volume migrations. As a leader, I have built and guided Shopify-focused development teams with strong repository governance and coding standards, while partnering with paid media, creative, and operations teams to turn commercial goals into scalable technical architecture. 
                </p>
              </div>
            </div>
