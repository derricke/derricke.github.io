  ...
  return (
    <article className="group relative flex flex-col items-start h-full rounded-xl border border-emerald-100 dark:border-zinc-800 bg-[#edf7f5] dark:bg-zinc-900/50 p-6 sm:p-8 transition-all hover:shadow-md dark:hover:shadow-zinc-900/50">
      ...
      <h2 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100 mb-4 font-outfit">
        <Link href={`/blog/${post.category}/${post.slug}`} className="underline decoration-gray-900/30 dark:decoration-gray-100/30 underline-offset-8 decoration-2 hover:decoration-gray-900 dark:hover:decoration-gray-100 transition-all">
          {post.title}
        </Link>
      </h2>
      ...
      <div className="flex items-center gap-4 text-sm font-outfit">
        <span className="text-gray-900 dark:text-gray-100 underline decoration-gray-900/30 dark:decoration-gray-100/30 underline-offset-4 hover:decoration-gray-900 dark:hover:decoration-gray-100 transition-all">
          {post.author.name}
        </span>
